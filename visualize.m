function h = visualize(type, rel_path,num_images,key_name,rows,cols,x_roi,y_roi,roi_w,roi_h) 
    ...
    hold on
    boxplot(boxvals_xx(:,1:num_images-1),'positions', Strain_clamp,'labels',Strain_label,'symbol','','Whisker',0.7)
    ...
    hold on
    boxplot(boxvals_yy(:,1:num_images-1)*100,'positions', Strain_clamp,'labels',Strain_label,'symbol','','Whisker',0.7)
    set(findobj(gca,'type','line'),'linew',1.8)
    xlabel('Clamp Strain (%)','FontSize',14,'FontWeight','bold')
    ...
    hold on
    boxplot(boxvals_xy(:,1:num_images-1),'positions', Strain_clamp,'labels',Strain_label,'symbol','','Whisker',0.7)
    set(findobj(gca,'type','line'),'linew',1.8)
    xlabel('Clamp Strain (%)','FontSize',14,'FontWeight','bold')
